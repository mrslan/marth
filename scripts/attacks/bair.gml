...
set_hitbox_value(AT_BAIR, 2, HG_EFFECT, 2);
set_hitbox_value(AT_BAIR, 2, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, 1.2);
set_hitbox_value(AT_BAIR, 2, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_burnconsume"));
